...
import { Grid, Center, Text3D, GizmoHelper, GizmoViewport, AccumulativeShadows, RandomizedLight,   useGLTF } from '@react-three/drei'
...
const Shadows = memo(() => (
  <AccumulativeShadows temporal frames={100}  colorBlend={0.5} alphaTest={0.5} scale={10}>
